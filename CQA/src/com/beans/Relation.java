...
public class Relation {
	...
	public void addToLeft(int attributeIndex) {
		this.dependency.addToLeft(attributeIndex);
	}

	public void addToRight(int attributeIndex) {
		this.dependency.addToRight(attributeIndex);
	}
	...
	public void print() {
		...
		if (getDependency() != null)
			System.out.println("FD: " + getDependency().toString());
		else
			System.out.println("FD: None");
